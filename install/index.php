...
if (isset($_GET['f'])) {
	...
	$sql .= file_get_contents(ROOT_PATH.'./install/data/account.sql');
	$sql .= file_get_contents(ROOT_PATH.'./install/data/circuitplus.sql');
	$sql .= file_get_contents(ROOT_PATH.'./install/data/circuitplus_extra.sql');

	$sql .= file_get_contents(ROOT_PATH.'./install/data/circuitplus_data.sql');
}
$sql = str_replace("\r\n", "\n", $sql);
