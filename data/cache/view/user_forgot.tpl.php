...
<html>
  ...
  <body id='example'>
    ...
    <div id='<?php echo (($_G['basescript'] == 'circuit') ? CURMODULE : '') ?>' class='main container <?php echo is_array($_G['basescript']) ? implode(" ", $_G['basescript']) : $_G['basescript'] ?>'>
      <div class='forgot-board'>
        <form id='forgot_form' autocomplete='on' action='/user/forgot/submit' method='POST' class='ui form segment'>
          ...
          <div id='btnsubmit' tabindex='3' onclick='check_forgot();' class='ui blue submit button btn btn-primary'>
