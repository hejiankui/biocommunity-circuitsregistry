...
<html>
  ...
  <body id='example'>
      ...
      <div class='segment'>
        <div class='container'>
          <div class='inverted pull-right'>
            <a href='/user/signup' class='ui red large labeled button'>
              Sign up
            </a>
          </div>
          <div id='login-welcome' class='introduction'>
            <h1 class='ui dividing header'>
              Sign in
            </h1>
            <p class='lead'>
              Welcome back to Circuit+
            </p>
          </div>
        </div>
      </div>
    ...
    <div id='<?php echo (($_G['basescript'] == 'circuit') ? CURMODULE : '') ?>' class='main container <?php echo is_array($_G['basescript']) ? implode(" ", $_G['basescript']) : $_G['basescript'] ?>'>
      <div class='span7'>
        <div class='signin-board'>
          <form id='login_form' autocomplete='on' action='/user/signin/login' method='POST' class='ui form segment'>
            ...
            <div id='username' class='field <?php echo is_array(($err['username'] ? 'error' : '')) ? implode(" ", ($err['username'] ? 'error' : '')) : ($err['username'] ? 'error' : '') ?>'>
              <label>
                Username
              </label>
            ...
            <div id='remember-forgot' class='inline field'>
            ...
            <div class='inline field'>
              <a href='/user/forgot' class='item'>
                Forgot?
              </a>
            </div>
            <div id='btnsubmit' tabindex='4' onclick='check_login();' class='ui blue submit button btn btn-primary'>
              Sign in
            </div>
          </form>
        </div>
