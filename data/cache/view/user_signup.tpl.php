    ...
    <div class='header'>
      <div class='segment'>
        <div class='container'>
          ...
          <div id='signup-welcome' class='introduction'>
    ...
    <div id='<?php echo (($_G['basescript'] == 'circuit') ? CURMODULE : '') ?>' class='main container <?php echo is_array($_G['basescript']) ? implode(" ", $_G['basescript']) : $_G['basescript'] ?>'>
      <div class='span7'>
        <div class='signup-board'>
          <form id='signup_form' autocomplete='off' action='/user/signup/submit' method='POST' class='ui form segment'>
            ...
            <div id='email' class='field <?php echo is_array(($err['email'] ? 'error' : '')) ? implode(" ", ($err['email'] ? 'error' : '')) : ($err['email'] ? 'error' : '') ?>'>
              <label>
                Email
              </label>
              <div class='ui left labeled icon input'>
            ...
            <div id='agree' class='inline field'>
            ...
            <div id='btnsubmit' tabindex='4' onclick='check_signup();' class='ui blue submit button btn btn-primary'>
              Submit
            </div>
          </form>
        </div>
