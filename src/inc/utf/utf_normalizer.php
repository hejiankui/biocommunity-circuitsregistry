	...
	*/
	function cleanup(&$str)
	{
		...
		if (!isset($GLOBALS['utf_nfc_qc']))
		{
			...
			include(BM_ROOT . 'src/inc/utf/data/utf_nfc_qc.php');
		}

		if (!isset($GLOBALS['utf_canonical_decomp']))
		{
			
			include(BM_ROOT . 'src/inc/utf/data/utf_canonical_decomp.php');
		}
	...
	*/
	function nfkc(&$str)
	{
		...
		if (!isset($GLOBALS['utf_nfkc_qc']))
		{
			...
			include(BM_ROOT . 'src/inc/utf/data/utf_nfkc_qc.php');
		}

		if (!isset($GLOBALS['utf_compatibility_decomp']))
		{
			
			include(BM_ROOT . 'src/inc/utf/data/utf_compatibility_decomp.php');
		}
	...
	*/
	function recompose($str, $pos, $len, &$qc, &$decomp_map)
	{
		...
		if (!isset($utf_jamo_index, $utf_jamo_type, $utf_combining_class))
		{
			...
			include(BM_ROOT . 'src/inc/utf/data/utf_normalizer_common.php');
		}
		...
		if (!isset($utf_canonical_comp))
		{
			...
			include(BM_ROOT . 'src/inc/utf/data/utf_canonical_comp.php');
		}
