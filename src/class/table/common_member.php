 ...
 *      SUSTC-ShenZhen-B
 *
 *      $Id: class/table/common_member.php 2013-06-14 09:10:00 Zhuoteng Peng $
 */
...
class table_common_member extends bm_table_archive
{
	...
	public function split($splitnum, $iscron = false) {
		...
		@set_time_limit(0);
		bm_database_safecheck::setconfigstatus(0);
		$dateline = TIMESTAMP - 7776000;//60*60*24*90
	...
	public function switch_keys($type) {
		...
		require_once libfile('func/cache');
		updatecache('setting');
	}
