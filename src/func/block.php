 ...
 *      SUSTC-ShenZhen-B
 *
 *      $Id: func/block.php 2013-06-13 17:17:00 Zhuoteng Peng $
 */
...
function block_updatecache($bid, $forceupdate=false) {
	global $_G;
	if((isset($_G['block'][$bid]['cachetime']) && $_G['block'][$bid]['cachetime'] < 0) || !$forceupdate && ei_process::islocked('block_update_cache', 5)) {
		return false;
	}
	...
	ei_process::unlock('block_update_cache');
}
