 ...
 *      SUSTC-ShenZhen-B
 *
 *      $Id: lang/zh-cn/error.php 2013-06-13 11:41:00 Zhuoteng Peng $
 */
...
(
	...
	'config_notfound' => '配置文件 "conf/global.php" 未找到或者无法访问， 请确认您已经正确安装了程序',
	...
	'db_error_no' => '错误代码',
	'db_notfound_config' => '配置文件 "conf/global.php" 未找到或者无法访问。',
	'db_notconnect' => '无法连接到数据库服务器',
	'db_security_error' => '查询语句安全威胁',
	'db_query_sql' => '查询语句',
	'db_query_error' => '查询语句错误',
	'db_config_db_not_found' => '数据库配置错误，请仔细检查 conf/global.php 文件',
